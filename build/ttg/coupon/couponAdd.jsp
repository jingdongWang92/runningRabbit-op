                    ...
                    <form id="fo" method="post" class="form-horizontal"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                ...
                                <option value="<s:property value="#act.id"/>"><s:property value="#act.name"/></option>
                                </s:iterator>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input type="text" maxlength="20" readonly="readonly" id="startDate" class="form-control" name="dto.startDate" required data-bv-notempty-message="开始日期为必填项"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input type="text" maxlength="20" readonly="readonly" id="endDate" class="form-control" name="dto.endDate" required data-bv-notempty-message="结束日期为必填项"
    ...
    $(function(){
        ...
        $('#fo').bootstrapValidator({
            ...
            submitHandler:function(form){
                ajaxPostRequest('coupon_add.action', 'fo', function callback(result){
