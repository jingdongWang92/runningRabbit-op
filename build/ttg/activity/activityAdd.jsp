                    ...
                    <form id="fo" method="post" class="form-horizontal"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                ...
                                placeholder="用户可见度" value="10000"onkeyup="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}" onafterpaste="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                ...
                                placeholder="积分数量" value="1"onkeyup="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}" onafterpaste="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                ...
                                placeholder="兔子刷新周期 单位:分钟" value="120"onkeyup="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}" onafterpaste="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}"/>
                            </div>
                        </div>
                        <div class="form-group">
    ...
    $(function(){
        ...
        $('#fo').bootstrapValidator({
            ...
            submitHandler:function(form){
                ajaxPostRequest('activity_add.action', 'fo', function callback(result){
