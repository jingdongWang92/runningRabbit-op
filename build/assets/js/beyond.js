...
function InitiateWidgets() {
    $('.page-container').on("click", '.widget-buttons *[data-toggle="maximize"]', function (n) {
        n.preventDefault();
    ...
    $('.page-container').on("click", '.widget-buttons *[data-toggle="collapse"]', function (n) {
        n.preventDefault();
    ...
    $('.page-container').on("click", '.widget-buttons *[data-toggle="dispose"]', function (n) {
        n.preventDefault();
